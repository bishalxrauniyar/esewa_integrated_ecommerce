        ...
        <div class="row"><!-- row Starts -->
            ...
            <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Starts -->
                ...
                <p><!-- p Starts -->
                    ...
                    <br>Kathmandu
                    <br>Nepal
                    <br>9818466311//9800000001
                    <br>
                    <strong>Powered by:Bishal Rauniyar</strong>
            ...
            <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Starts -->
                ...
                <p class="social"><!-- social Starts --->
                    ...
                    <a href="https://www.instagram.bishalxrauniyar.com.np/"><i class="fa fa-instagram"></i></a>
...
<div id="copyright"><!-- copyright Starts -->
    ...
    <div class="container"><!-- container Starts -->
        ...
        <div class="col-md-6"><!-- col-md-6 Starts -->
            ...
            <p class="pull-left"> &copy; Watches_Nepa </p>
        ...
        <div class="col-md-6"><!-- col-md-6 Starts -->
            ...
            <p class="pull-right">
                ...
                Template by <a href="https://www.facebook.com/bishal.rauniyar/">Bishal</a>
